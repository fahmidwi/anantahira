              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo base_url('admin/berita/edit/'.$res->id_berita) ?>"><span
                          class="badge badge-default">Edit</span></a>
                      <a href="<?php echo base_url('admin/berita/hapus/'.$res->id_berita) ?>"><span
                      ...
                      <a href="<?php echo base_url('news/detail/'.$res->id_berita.'/'.$res->uriberita) ?>"
                        target="_blank"><span class="badge badge-info">Detail</span></a>
                    </td>
                  </tr>
                  <?php $no++; } ?>
                </tbody>
