        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              ...
              <form action="<?php echo base_url('admin/KategoriBerita/prosesedit/'.$kategori->id_kategori) ?>" method="POST"
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="kategori_berita" required=""
                        value="<?php echo $kategori->nama_kategori; ?>" placeholder="Masukan Kategori Berita">
                    </div>
                  </div>
                  <div class="col-md-12">
