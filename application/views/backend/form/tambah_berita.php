        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              ...
              <form action="<?php echo base_url('admin/berita/prosestambah') ?>" method="POST"
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <textarea type="text" class="form-control" name="caption_singkat" required=""
                        placeholder="Masukan Caption Singkat"></textarea>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="isi_berita" id="editor"
                        style="overflow-y: 300px;"></textarea>
