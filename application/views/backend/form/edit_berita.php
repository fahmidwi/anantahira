              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="" required="" placeholder="Masukan Judul Berita">
                  </div>
                  <div class="form-group">
                    <label>Caption Singkat</label>
                    <textarea type="text" class="form-control" name="" required="" placeholder="Masukan Caption Singkat"></textarea>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <textarea  class="form-control" name="" id="editor" style="overflow-y: 300px;"></textarea>
    ...
    <div class="container-fluid mt--7">
      ...
      <div class="row">
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <h3 class="mb-0">Ubah Data Kategori Berita</h3><br><br>
            <form>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
